...
public class ImageActivity extends AppCompatActivity implements ImageAdapter.OnItemClickListener {
    ...
    public void OnItemClick(int position) {
        Toast.makeText(this, "Натисніть та утримуйте, позіція: " + position, Toast.LENGTH_SHORT).show();
    }
    ...
    public void onDeleteClick(int position) {
        ...
        imageRef.delete().addOnSuccessListener(new OnSuccessListener<Void>() {
            ...
            public void onSuccess(Void aVoid) {
                ...
                Toast.makeText(ImageActivity.this, "Запис видалено", Toast.LENGTH_SHORT).show();
            }
        });
    }
